...
class compute_label(Container):
    ...
    def __init__(self, viewer:"napari.viewer.Viewer"):
        ...
        self._titlemasklabel.native.setStyleSheet("background-color: rgb(037, 041, 049); border: 1px solid black;")
        ...
        self._titlewatershedlabel.native.setStyleSheet("background-color: rgb(037, 041, 049); border: 1px solid black;")
    ...
    def compute(self):
        ...
        if _algorithm == "Unet":
            ...
            self._viewer.add_labels(seg_man.labels,name='Labels')
